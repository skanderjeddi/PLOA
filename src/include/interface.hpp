...
public:
     ...
     */
    virtual void drawBoard(B &,
                           const sf::Vector2i & = sf::Vector2i(0, 0)) = 0;
    /**
     * @brief Draws a tile on the screen.
     */
    virtual void drawTile(T &,
                          const sf::Vector2i &,
                          const sf::Vector2i & = sf::Vector2i(0, 0)) = 0;
    /**
    ...
    {
        if (DEBUG)
            std::cout << "Registering " << ptr << " for rendering..." << std::endl;
    ...
    void render()
    {
        ...
        {
            if (DEBUG)
                std::cout << "Deleting " << toRender[i] << " ..." << std::endl;
            delete toRender[i];
     ...
     */
    UserInterfaceProperties getProperties() const
    {
        return properties;
    }
    /**
